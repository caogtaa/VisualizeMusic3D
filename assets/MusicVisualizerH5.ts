...
import { _decorator, Sprite, RenderTexture, SpriteFrame } from 'cc';
const {ccclass, property} = _decorator;

@ccclass('MusicVisualizerH5')
export default class MusicVisualzierH5 extends Sprite {
    ...
    protected _fftSampleTexture: RenderTexture | null = null;
    ...
    protected FlushMatProperties(sprite: Sprite) {
        // use default
