...
import { _decorator, RenderTexture, SpriteFrame, Node, Camera, Texture2D, Component, AudioClip, Sprite, Material } from 'cc';
...
class RenderBuff {
    ...
    public static CreateComputeBuff(width: number, height: number): RenderBuff {
        ...
        result.spriteFrame = new SpriteFrame(texture);
        return result;
    }
    /**
     * 清空纹理内容
...
export default class SceneVisualizeMusic extends Component {
     ...
     * @returns 
     */
    public RenderToNode(root: cc.Node, target: cc.Node): RenderTexture {
